...
query_template = Template("Describe en dos frases en texto plano $destino para un turista que visita por primera vez.")
...
def query_ollama(query):
    query = query_template.substitute(destino=query) if query else query_template.substitute(destino="París")
    #192.168.0.11
